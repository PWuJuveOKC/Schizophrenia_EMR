...
pyLDAvis.save_html(lda_display_bow, 'src/output/lda_bow_' + domain + '_' + str(cohort) + '.html')
...
filename = 'drug_drug_concept_id_0.013' # use the file name that you want to transform
...
id_na = dict(zip(["\""+x+"\"" for x in id_name.iloc[:,0]], \
