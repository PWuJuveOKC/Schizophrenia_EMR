...
dat_drug = pd.read_csv('src/int_data/feat_eng/medication_{}_feat.csv'.format(feat_eng)) #tm: 942
dat_condition = pd.read_csv('src/int_data/feat_eng/condition_{}_feat.csv'.format(feat_eng)) #tm: 3652
dat_procedure = pd.read_csv('src/int_data/feat_eng/procedure_{}_feat.csv'.format(feat_eng)) #tm: 2615
dat_measure = pd.read_csv('src/int_data/feat_eng/lab_{}_feat.csv'.format(feat_eng)) #tm: 2522
...
# topics_merged = pd.merge(topics_merged0, dat_drug, on=['person_id'], how='left')
...
df_shuffled.to_csv('src/int_data/feat_eng/merged_data_{}.csv'.format(feat_eng), index=None)